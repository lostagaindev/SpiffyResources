...
public class SliderBar extends FocusPanel implements RequiresResize, HasValue<Double>,
  ...
  /**
   * Indicates if currently sliding the slider bar due
   * to keyboard events.
   */
  ...
  /**
   * Indicates if the slider is enabled
   */
  ...
  public void onBrowserEvent(Event event) {
    ...
    if (enabled) {
    	...
    	//oddly, no touch events for move etc
    	//yet it still works on touchscreens :? hu?
